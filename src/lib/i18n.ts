...
const translations = {
  en: {
    onboarding: {
      ...
      feature_reminders_diff: "Other AI tools forget. Kai actually sends you the reminder.",
  ...
  es: {
    onboarding: {
      ...
      feature_reminders_diff: "Otros asistentes olvidan. Kai te manda el recordatorio de verdad.",
