...
export default function PandaHub() {
  ...
  return (
    <div className="h-screen bg-[var(--background)] flex flex-col overflow-hidden fixed inset-0">
      ...
      <nav className="fixed bottom-4 left-4 right-4 mx-auto max-w-xs h-14 bg-[var(--background)]/90 backdrop-blur-lg rounded-full shadow-lg shadow-black/10 dark:shadow-black/30 flex items-center justify-around px-2 safe-area-pb">
        <button 
          className="flex items-center gap-2 px-4 py-2 rounded-full bg-[#6b8f71]/10 text-[#6b8f71] transition-all"
        >
        ...
        <button 
          ...
          className="flex items-center justify-center w-10 h-10 rounded-full text-[var(--gray-4)] hover:text-[var(--foreground)] hover:bg-[var(--gray-1)] transition-all relative"
        >
